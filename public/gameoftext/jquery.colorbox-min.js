...
(function (t, e, i) {
            ...
            : ((o = t(this.el).attr("data-cbox-" + e)),
              void 0 !== o
                ...
                : void 0 !== i[e]
                  ...
                  : void 0 !== X[e] && (n = X[e]),
              (this.cache[e] = n)),
          t.isFunction(n) ? n.call(this.el) : n
        );
      }));
  }
  function h(t) {
  ...
  function s(t, e) {
    return Math.round(
      (/%/.test(t) ? ("x" === e ? W.width() : n()) / 100 : 1) * parseInt(t, 10),
    );
  }
  function a(t, e) {
  ...
  function g() {
    ((z = 0),
      rel && "nofollow" !== rel
        ? ((E = t("." + te).filter(function () {
            var e = t.data(this, Y),
              i = new r(this, e);
            return i.get("rel") === rel;
          })),
          (z = E.index(_.el)),
          -1 === z && ((E = E.add(_.el)), (z = E.length - 1)))
        : (E = t(_.el)));
  }
  function u(i) {
  ...
  function f(i) {
    ...
    G ||
      ...
      $ ||
        ...
        (A = L.outerHeight(!0)),
        (N = L.outerWidth(!0)),
        (_.w = s(_.get("initialWidth"), "x")),
        (_.h = s(_.get("initialHeight"), "y")),
  ...
  function p() {
    !x &&
      ...
      (x = o(ae)
        ...
        .hide()),
      (v = o(ae, "Overlay").hide()),
      (M = t([o(ae, "LoadingOverlay")[0], o(ae, "LoadingGraphic")[0]])),
      (y = o(ae, "Wrapper")),
      (b = o(ae, "Content").append(
        (R = o(ae, "Title")),
        (F = o(ae, "Current")),
        (P = t('<button type="button"/>').attr({ id: Z + "Previous" })),
        (K = t('<button type="button"/>').attr({ id: Z + "Next" })),
        (I = o("button", "Slideshow")),
        M,
      )),
      ...
      (O = K.add(P).add(F).add(I)),
      t(e.body).append(v, x.append(y, S)));
  }
  function m() {
    function i(t) {
      t.which > 1 ||
  ...
  function w() {
    ...
    ((q = !0),
      ...
      _.get("onLoad"),
      (_.h = _.get("height")
        ? s(_.get("height"), "y") - A - D
        : _.get("innerHeight") && s(_.get("innerHeight"), "y")),
      (_.w = _.get("width")
        ? s(_.get("width"), "x") - N - j
        : _.get("innerWidth") && s(_.get("innerWidth"), "x")),
      (_.mw = _.w),
      (_.mh = _.h),
      _.get("maxWidth") &&
        ((_.mw = s(_.get("maxWidth"), "x") - N - j),
        (_.mw = _.w && _.w < _.mw ? _.w : _.mw)),
      _.get("maxHeight") &&
        ((_.mh = s(_.get("maxHeight"), "y") - A - D),
      ...
      _.get("inline")
        ? ((h = o(ae).hide().insertBefore(t(n)[0])),
          se.one(he, function () {
        ...
        : _.get("iframe")
          ...
          : _.get("html")
            ...
            : a(_, n)
              ...
              : n &&
                S.load(n, _.get("data"), function (e, i) {
                  c === le &&
                    d(
                      "error" === i
                        ? o(ae, "Error").html(_.get("xhrError"))
                        : t(this).contents(),
                    );
                }));
  }
  var v,
    ...
    ce = (function () {
      ...
      function i() {
        (I.html(_.get("slideshowStop")).unbind(a).one(a, o),
          se.bind(oe, e).bind(ie, t),
          x.removeClass(s + "off").addClass(s + "on"));
      }
      function o() {
        (t(),
          se.unbind(oe, e).unbind(ie, t),
          I.html(_.get("slideshowStart"))
            .unbind(a)
            .one(a, function () {
              (J.next(), i());
            }),
      ...
      return function () {
        r
          ? _.get("slideshow") || (se.unbind(ne, n), n())
          : _.get("slideshow") &&
            E[1] &&
            ((r = !0),
            se.one(ne, n),
            _.get("slideshowAuto") ? i() : o(),
            I.show());
      };
    })();
  t.colorbox ||
    ...
    (J.position = function (e, i) {
      function o() {
        ((T[0].style.width =
          k[0].style.width =
          b[0].style.width =
            parseInt(x[0].style.width, 10) - j + "px"),
          (b[0].style.height =
            C[0].style.height =
            H[0].style.height =
              parseInt(x[0].style.height, 10) - D + "px"));
      }
      var r,
        h,
        a,
      ...
      if (
        ...
        (a = W.scrollLeft()),
        _.get("fixed")
          ? ((c.top -= h), (c.left -= a), x.css({ position: "fixed" }))
          : ((l = h), (d = a), x.css({ position: "absolute" })),
        (d +=
          _.get("right") !== !1
            ? Math.max(W.width() - _.w - N - j - s(_.get("right"), "x"), 0)
            : _.get("left") !== !1
              ? s(_.get("left"), "x")
              : Math.round(Math.max(W.width() - _.w - N - j, 0) / 2)),
        (l +=
          _.get("bottom") !== !1
            ? Math.max(n() - _.h - A - D - s(_.get("bottom"), "y"), 0)
            : _.get("top") !== !1
              ? s(_.get("top"), "y")
              : Math.round(Math.max(n() - _.h - A - D, 0) / 2)),
    ...
    (J.resize = function (t) {
      ...
      $ &&
        ((t = t || {}),
        t.width && (_.w = s(t.width, "x") - N - j),
        t.innerWidth && (_.w = s(t.innerWidth, "x")),
        L.css({ width: _.w }),
        t.height && (_.h = s(t.height, "y") - A - D),
        t.innerHeight && (_.h = s(t.innerHeight, "y")),
        t.innerHeight ||
          t.height ||
            ...
            $ &&
              ...
              s > 1
                ? ("string" == typeof _.get("current") &&
                  ...
                  K[_.get("loop") || s - 1 > z ? "show" : "hide"]().html(
                    _.get("next"),
                  ),
              ...
              _.get("iframe")
                ? ((o = e.createElement("iframe")),
                  "frameBorder" in o && (o.frameBorder = 0),
                  "allowTransparency" in o && (o.allowTransparency = "true"),
                  _.get("scrolling") || (o.scrolling = "no"),
                  t(o)
                    .attr({
                      src: _.get("href"),
    ...
    (J.close = function () {
      $ &&
        ...
        x.stop().fadeTo(_.get("fadeOut") || 0, 0, function () {
          (x.add(v).css({ opacity: 1, cursor: "auto" }).hide(),
            u(he),
            L.remove(),
            setTimeout(function () {
