  ...
  JQConsole = (function () {
    ...
    JQConsole.prototype._VerticalMove = function (up) {
      var $prompt_opposite,
        ...
        text,
        _ref;
      ((_ref = this._GetDirectionals(up)),
        ($prompt_which = _ref.$prompt_which),
        ($prompt_opposite = _ref.$prompt_opposite),
        ($prompt_relative = _ref.$prompt_relative),
        (MoveToLimit = _ref.MoveToLimit),
    ...
    JQConsole.prototype._HorizontalMove = function (whole_word, back) {
      var $opposite_line,
        ...
        word,
        _ref;
      ((_ref = this._GetDirectionals(back)),
        ($prompt_which = _ref.$prompt_which),
        ($prompt_opposite = _ref.$prompt_opposite),
        ($prompt_relative = _ref.$prompt_relative),
        ($prompt_rel_opposite = _ref.$prompt_rel_opposite),
        (which_end = _ref.which_end),
        (where_append = _ref.where_append));
      regexp = back ? /\w*\W*$/ : /^\w*\W*/;
      text = $prompt_which.text();
      if (text) {
        if (whole_word) {
      ...
      read_char = function () {
        ...
        if (back) {
          ((_ref = text),
            (text =
              2 <= _ref.length
                ? __slice.call(_ref, 0, (_i = _ref.length - 1))
                : ((_i = 0), [])),
            (ret = _ref[_i++]));
        } else {
          ((_ref1 = text),
            (ret = _ref1[0]),
            (text = 2 <= _ref1.length ? __slice.call(_ref1, 1) : []));
        }
        if (ret) {
    ...
    JQConsole.prototype._ProcessMatch = function (config, back, before_char) {
      ...
      ((_ref = back
        ...
        (char = _ref[0]),
        (opposing_char = _ref[1]));
      ((_ref1 = this._GetDirectionals(back)),
        ($prompt_which = _ref1.$prompt_which),
        ($prompt_relative = _ref1.$prompt_relative));
      current_count = 1;
      found = false;
      ...
      ((_ref2 = this._WalkCharacters(
        ...
        (index = _ref2.index),
        (current_count = _ref2.current_count));
      if (index > -1) {
        ...
        $collection.each(function (i, elem) {
          ...
          ((_ref3 = _this._WalkCharacters(
            ...
            (index = _ref3.index),
            (current_count = _ref3.current_count));
          if (index > -1) {
            if (!back) {
              index--;
            }
