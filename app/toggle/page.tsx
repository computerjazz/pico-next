      ...
      <main className="flex flex-col">
        ...
        <div className="flex flex-col items-center">
          <div className="gap-4 max-w-lg flex flex-col p-4">
            <p>{`Keep one Toggle and give the other to a friend. The light stays green as long as they're both flipped the same way. Flip yours to turn your friend's Toggle red.`}</p>
